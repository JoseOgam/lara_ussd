...
class UssdController extends Controller
{
    public function onlineUssdMenu(Request $request)
    {
        ...
        if ($text == "") {
            ...
            Thank you for registering for Django online classes at HLAB.";
        } elseif ($text == "1*2") {
            ...
            // save data in the database
            $response = "END Your data has been captured successfully! Thank you for registering
            for Laravel online classes at HLAB.";
        } elseif ($text == "2") {
